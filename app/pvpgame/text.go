...
var (
	TextFightStart = "%v [%v] сражается против %v [%v]"
	TextDamage     = "%v атакует на %v урона, у %v осталось %v хп"
	...
	TextPlayerInfo = "%v (%v урон %v защ %v хп) оружие: %v [%v урон], защита: %v [%v защ %v хп]"
